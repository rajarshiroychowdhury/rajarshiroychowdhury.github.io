...
<!-- IEEE PES T&D 2026 oscillations Panel as Chair -->
<div class="card mt-3">
  <div class="p-3">
    <div class="row">
      <div class="col-sm-10">
        <h5 id="comp210" class="card-title">Evolving Power System Oscillations in the Era of IBRs and Large Load Interconnections </h5>
        <h6 class="card-subtitle font-italic"> Panel Discussion at the IEEE PES T&D 2026  Conference & Exposition in Chicago, IL, US on May 7, 2026</h6>
      </div>
      <div class="col-sm-2 text-sm-right">
        <span class="badge">
          2026 
    ...
    <ul class="card-text font-weight-light list-group list-group-flush">
      ...
      <li class="list-group-item">
        <div class="row">
          <div class="col-sm-10">
           Panelists : Dr. Marianna Vaiman, V&R Energy, Dr. Balaji Guddanti, GE Vernova, Dr. Ryan Elliott, Sandia National Laboratories, Dr. Shuchismita Biswas, Pacific Northwest National Laboratory, and Dr. Lin Zhu, EPRI.    
          </div>
          <div class="col-sm-3">
...
<!-- IEEE PES T&D 2026 Large Loads Panel as Chair -->
<div class="card mt-3">
  <div class="p-3">
    <div class="row">
      <div class="col-sm-10">
        <h5 id="comp210" class="card-title">Planning for Large Load Interconnections: Utility Challenges, Modeling, and Insights </h5>
        <h6 class="card-subtitle font-italic"> Panel Discussion at the IEEE PES T&D 2026  Conference & Exposition in Chicago, IL, US on May 6, 2026</h6>
      </div>
      <div class="col-sm-2 text-sm-right">
        <span class="badge">
          2026 
    ...
    <ul class="card-text font-weight-light list-group list-group-flush">
      ...
      <li class="list-group-item">
        <div class="row">
          <div class="col-sm-10">
           Panelists : Dr. Mostafa Sedighizadeh, Southwest Power Pool (SPP), Dr. Kannan Sreenivasachar, ISO New England (ISO-NE), Dr. Zhaoyu Wang, Iowa State University, Dr. Maryclaire Peterson, Entergy, and Dr. Mohit Singh, ComEd.    
          </div>
          <div class="col-sm-3">
            <!-- <a href="https://docs.google.com/presentation/d/12e1sxpIHf1mICBM6xSjnnCluqbAZQcE1cxS9P-yykdk/edit?usp=sharing" target="_blank" rel="noopener noreferrer">Slides</a>  -->
          </div>
...
<!-- Gurobi Powering Decisions Optimization Summit 2025 Denver CO -->
<div class="card mt-3">
  <div class="p-3">
    <div class="row">
      <div class="col-sm-10">
    ...
    <ul class="card-text font-weight-light list-group list-group-flush">
      <li class="list-group-item">
        <div class="row">
          <div class="col-sm-10">
            Panel Discussion Chair : Dr. Jonathan Snodgrass, Texas A&M University 
          </div>
          <div class="col-sm-3">
          </div>
        </div>
      ...
      <li class="list-group-item">
        <div class="row">
          <div class="col-sm-10">
           Panelists : Dr. Kyri Baker, University of Colorado Boulder, Nidhi Santen, EPRI International Inc., Dr. Amir Sajadi, Pacific Gas and Electric Company, and Dr. 
           Rajarshi Roychowdhury, Xcel Energy.    
          </div>
          <div class="col-sm-3">
            <!-- <a href="https://docs.google.com/presentation/d/12e1sxpIHf1mICBM6xSjnnCluqbAZQcE1cxS9P-yykdk/edit?usp=sharing" target="_blank" rel="noopener noreferrer">Slides</a>  -->
          </div>
